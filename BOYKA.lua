...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/TH3HILL/HILL/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,574812171,707182342,1430155471}   
...
if tonumber(user_id) == tonumber(707182342) then  
var = true  
elseif tonumber(user_id) == tonumber(574812171) then
var = true 
elseif tonumber(user_id) == tonumber(1430155471) then
var = true  
...
os.execute('wget https://raw.githubusercontent.com/TH3HILL/HILL/main/BOYKA.lua')
...
usertext = '\n ❃∫ العضو » ['..result.title_..'](t.me/'..(username or 'TH3HILL')..')'
status  = '\n ❃∫ تم ترقيته مطور'
...
usertext = '\n ❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'TH3HILL')..')'
status  = '\n ❃∫ تم ترقيته مطور'
...
if BOYKA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❃∫ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'TH3HILL')..') \n ❃∫ '..BOYKA1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/TH3HILL)}\n ❃∫ ["..BOYKA_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ❃∫ عذرا » {["..data.first_name_.."](T.ME/TH3HILL)}\n ❃∫ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
≪━━━━━━𝘽𝙆━━━━━━≫
 ❃∫ ↬𝐁𝐎𝐘𝐊𝐀 𝐓𝐄𝐀𝐌
≪━━━━━━𝘽𝙆━━━━━━≫
 ❃∫ ↬[Channel BOYKA](t.me/TH3HILL) 
≪━━━━━━𝘽𝙆━━━━━━≫
 ❃∫ ↬[Information](t.me/BOBBW)
≪━━━━━━𝘽𝙆━━━━━━≫
 ❃∫ ↬[DEVELOPER](t.me/CCFRR)
≪━━━━━━𝘽𝙆━━━━━━≫
 ❃∫ ↬[The way his inauguration](https://t.me/TH3HILL/365)
≪━━━━━━𝘽𝙆━━━━━━≫
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ❃∫ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'TH3HILL')..') \n ❃∫ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❃∫ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'TH3HILL')..') \n ❃∫ تـم قفـل التاك بالكتم ')
end,nil)   
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/TH3HILL/HILL/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ❃∫ اهلا بك في متجر ملفات بويكا\n ❃∫ ملفات السورس ↓\n≪━━━━━━𝘽𝙆━━━━━━≫\n\n"
local TextE = "\n≪━━━━━━𝘽𝙆━━━━━━≫\n ❃∫ علامة تعني { ✓ } ملف مفعل\n ❃∫ علامة تعني { ✘ } ملف معطل\n ❃∫ قناة سورس بويكا ↓\n".." ❃∫ [اضغط هنا لدخول](t.me/TH3HILL) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/TH3HILL/HILL/main/File_Bot/"..file)
if res == 200 then
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ❃∫ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'TH3HILL')..')'
status  = '\n ❃∫ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ❃∫ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❃∫ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'TH3HILL')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ❃∫ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'TH3HILL')..')'..'\n ❃∫ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'TH3HILL')..')'
local iduser = result.sender_user_id_
