...
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,1632008076,1203573116}
print("\27[34m"..[[

	 >> Best Source in Telegram
>> Features fast and powerful

 _______ _    _ ____  _    _ _____ _      _
|__   __| |  | |___ \| |  | |_   _| |    | |
   | |  | |__| | __) | |__| | | | | |    | |
   | |  |  __  ||__ <|  __  | | | | |    | |
   | |  | |  | |___) | |  | |_| |_| |____| |____
...
local UserName = (data.username_ or "thehill")
...
send(msg.chat_id_, msg.id_, "💢┇لا تسطيع حظر البوت عامل--دمشيي لكك")
return false 
end
database:sadd(bot_id.."Tshake:GBan:User", result.sender_user_id_)
Kick_Group(result.chat_id_, result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","💢┇تم حظره عام من المجموعات-دييي")  
end
...
local userid = text:match("^رفع بكلبي (%d+)$")
if not Constructor(msg) and database:get(bot_id.."Add:Group:Cheking"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,'✖┇لا تستطيع رفع احد وذالك لان تم تعطيل الرفع من قبل المنشئين')
return false
end
...
if text == ("اخلع") and msg.reply_to_message_id_ ~= 0 and Owner(msg) then
function Function_Tshake(extra, result, success)
if tonumber(SUDO) == tonumber(result.sender_user_id_) then
send(msg.chat_id_, msg.id_,"💢┇-ويامن دتلعب لا تستطيع تنزيل المطور الاساسي")
return false 
end
...
local UserName = (b.username_ or "thehill")
...
if text == (database:get(bot_id.."Tshake:Name:Bot") or "الجحيم") then
Namebot = (database:get(bot_id.."Tshake:Name:Bot") or "الجحيم")
local namebot = {
...
if text == 'تفع' and Owner(msg) then   
database:del(bot_id..'Tshake:Lock:ID:Bot:Photo'..msg.chat_id_) 
send(msg.chat_id_, msg.id_,'☑┇تم تفعيل الايدي بالصوره') 
end
...
if text == 'تعط' and Owner(msg) then  
database:set(bot_id..'Tshake:Lock:ID:Bot:Photo'..msg.chat_id_,true) 
send(msg.chat_id_, msg.id_,'☑┇تم تعطيل الايدي بالصوره') 
end
...
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان","خنزير","لقلق","عظمه","ملعقه","كرة قدم","كرة سله","سكيت","مايك","هيدفون","دراجه ناريه","تكتك","طياره","صاروخ","صندوق","سجاره","سكين","علم العراق","قفل","قلم رصاص","فيونكا","مفتاح","كبسوله","شمعه","بطاريه"}
...
name = string.gsub(name,"خنزير","🐷")
name = string.gsub(name,"لقلق","🦩")
name = string.gsub(name,"عظمه","🦴")
name = string.gsub(name,"ملعقه","🥄")
name = string.gsub(name,"كرة قدم","⚽️")
name = string.gsub(name,"كرة سله","🏀")
name = string.gsub(name,"سكيت","🛹")
name = string.gsub(name,"مايك","🎤")
name = string.gsub(name,"هيدفون","🎧")
name = string.gsub(name,"دراجه ناريه","🏍")
name = string.gsub(name,"تكتك","🛺")
name = string.gsub(name,"طياره","✈️")
name = string.gsub(name,"صاروخ","🚀")
name = string.gsub(name,"صندوق","📦")
name = string.gsub(name,"سجاره","🚬")
name = string.gsub(name,"سكين","🔪")
name = string.gsub(name,"علم العراق","🇮🇶")
name = string.gsub(name,"قفل","🔒")
name = string.gsub(name,"قلم رصاص","✏️")
name = string.gsub(name,"فيونكا","🎀")
name = string.gsub(name,"مفتاح","🔑")
name = string.gsub(name,"كبسوله","💊")
name = string.gsub(name,"شمعه","🕯")
name = string.gsub(name,"بطاريه","🔋")
...
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ","ظالم","اخذ","مجنون","مليان","ضيق","اعترف","لين","احبك","ذهاب","ممنوع","ولد","مبكر","رطب","سؤال","حزن","بكاء","امين","فوق","يمين","كبير","طويل","حار","صعب","قليل","نور"}
...
name = string.gsub(name,"اعطى","اخذ")
name = string.gsub(name,"الخفيه","الجهر")
name = string.gsub(name,"عاقل","مجنون")
name = string.gsub(name,"فارغ","مليان")
name = string.gsub(name,"واسع","ضيق")
name = string.gsub(name,"انكر","اعترف")
name = string.gsub(name,"صلب","لين")
name = string.gsub(name,"اكرهك","احبك")
name = string.gsub(name,"اياب","ذهاب")
name = string.gsub(name,"مسموح","ممنوع")
name = string.gsub(name,"بنت","ولد")
name = string.gsub(name,"متأخر","مبكر")
name = string.gsub(name,"جواب","سؤال")
name = string.gsub(name,"جاف","رطب")
name = string.gsub(name,"فرح","حزن")
name = string.gsub(name,"ضحك","بكاء")
name = string.gsub(name,"خائن","امين")
name = string.gsub(name,"تحت","فوق")
name = string.gsub(name,"يسار","يمين")
name = string.gsub(name,"صغير","كبير")
name = string.gsub(name,"قصير","طويل")
name = string.gsub(name,"بارد","حار")
name = string.gsub(name,"سهل","صعب")
name = string.gsub(name,"كثير","قليل")
name = string.gsub(name,"ظلام","نور")
...
download_to_file('https://raw.githubusercontent.com/TH3HILL/HILL/master/Tshake.lua', 'Tshake.lua') 
download_to_file('https://raw.githubusercontent.com/TH3HILL/HILL/master/start.lua', 'start.lua') 
dofile('Tshake.lua')  
return false
end
...
if DevTshake(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/TH3HILL/HILL/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n📂┇اهلا بك في متجر ملفات الجحيم \n📮┇الملفات الموجوده حاليا \nꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ\n\n"
...
local json_file, res = https.request("https://github.com/TH3HILL/HILL/filez/"..file)
if res == 200 then
...
🌐┇TheHiLL TEAM 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
👻┇ [Source Channel](https://t.me/th3hill)

😍┇ [TheHiLL Dev](https://t.me/mmmx9)
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
📧┇ [TWS TheHiLL](https://t.me/th3HiLLBoT)
]]
send(msg.chat_id_, msg.id_,Text)
end
...
local Name_Bot = (database:get(bot_id.."Tshake:Name:Bot") or "الجحيم")
